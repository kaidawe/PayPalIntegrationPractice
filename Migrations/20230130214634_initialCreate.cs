...
namespace PaypalLab.Migrations
{
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "CAD", "Are you looking for a fun and affordable way to pass the time? Look no further than our high-quality deck of cards! At only $3.79, this deck of cards is an excellent value.", "DeckOfCards.png", "3.79", "Red Cards" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ID", "Currency", "Description", "Image", "Price", "ProductName" },
                values: new object[] { 2, "CAD", "Are you tired of being caught without an ace up your sleeve? Well, have no fear! Our special deck of cards comes with an extra ace, so you can always have the upper hand. And at just $4.95, it's a steal!", "FiveAces.jpg", "4.95", "Extra Ace" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ID", "Currency", "Description", "Image", "Price", "ProductName" },
                values: new object[] { 3, "CAD", "Upgrade your card game with our premium black-styled deck of cards. Made with high-quality materials and featuring a sleek black design. At just $7.79, it's a small price to pay to make a big statement!", "BlackDeck.jpeg", "7.79", "Black Deck" });
